...
const PROJECT_NAME = "Notebook";

const PRODUCT_IDENTIFIER = "notebook_premium_monthly";
const PLAY_STORE_PRODUCT_IDENTIFIER = "notebook_premium_monthly:monthly";

const PRODUCT_DISPLAY_NAME = "Notebook Premium Monthly";
const PRODUCT_USER_FACING_TITLE = "Notebook Premium";
const PRODUCT_DURATION = "P1M";

const APP_STORE_APP_NAME = "Notebook iOS";
const APP_STORE_BUNDLE_ID = "com.notebook.app.ios";
const PLAY_STORE_APP_NAME = "Notebook Android";
const PLAY_STORE_PACKAGE_NAME = "com.notebook.app.android";
